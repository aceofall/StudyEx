...
class Virus(object):
    ...
    def __init__ (self):
        ...
        self.logger = logging.getLogger('virusLogger')
        fileHandler = logging.FileHandler('./virus.log')
    ...
    def getInput(self):
        ...
        InputParams['com_nums'] = int(input())
        InputParams['connection_nums'] = int(input())
        pairs = []
        for  _ in range(InputParams['connection_nums']):
            connection = [ int(x) for x in input().strip().split(' ') ]
            #connection.append([ int(x) for x in input().strip().split(' ') ])
